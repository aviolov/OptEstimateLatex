...
\input{../OptSpike/local_style.sty}
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{Figs/PathSimulator/path_T=14_combined.pdf}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.8\textwidth]{Figs/HJB/Regimes_valuesurf.pdf}
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{Figs/HJB/Regimes_controlsurf.pdf}
...
%   \includegraphics[width=\textwidth]{Figs/FP_Adjoint/Regimes_cs.pdf}
  \includegraphics[width=0.8\textwidth]{Figs/FP_Adjoint/Regimes_cs_singleplot.pdf}
...
\caption[Controller Performance]{Realized and theoretical performance of the
different control laws. The empirical performance is obtained using $N=10000$ sample paths. The theoretical
...
\subfloat[Sub-Threshold High-Noise]{
  ...
  \caption[Controlled spike-time histograms]{Histogram of the spike timing error
  for the deterministic (left) vs. open-loop stochastic (centre) vs. closed-loop
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{Figs/TrainController/SingleISI_ControlError_Stats.pdf}
...
\label{fig:targettrain_cl_highnoise}
  \includegraphics[width=0.8\textwidth]{Figs/TrainController/SUPT_HN_cl_Amax2_trains_sim_50.pdf}
  }
  \\ 
\subfloat[Open-Loop controller]{
   \label{fig:targettrain_ol_highnoise} 
  \includegraphics[width=0.8\textwidth]{Figs/TrainController/SUPT_HN_ol_Amax2_trains_sim_50.pdf}
  }
...
\subfloat[Closed-Loop Controller]{
  ...
  \includegraphics[width=0.8\textwidth]{Figs/TrainController/SUPT_HN_cl_Amax4_trains_sim_50.pdf}
  }\\
\subfloat[Open-Loop Controller]{
\includegraphics[width=0.8\textwidth]
...
\begin{figure}
\begin{center}
  \includegraphics[width=0.8\textwidth]{Figs/MLBox/ML_estimates_annotated.pdf} 
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{Figs/HJB/RegimesHighEps_controlsurf.pdf}
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{Figs/FP_Adjoint/RegimesHighEps_cs_singleplot.pdf}
