\chapter{Estimation in the Sinusoidally-driven Leaky-Integrate and Fire Model}
...
\input{../LIFEPaper/local_style.sty}
...
In this chapter, we thus describe and discuss two methods to estimate parameters
...
% }
\includegraphics[width=0.8\textwidth]{Figs/Trajectories/path_T=24_combined.pdf} 
\end{center}
...
% }
\includegraphics[width=0.8\textwidth]{Figs/FP/regimes_pdf_combined.pdf}
...
% }
\includegraphics[width=0.8\textwidth]{Figs/FP/regimes_sdf_combined.pdf}
...
\includegraphics[width=.8\textwidth]{Figs/FP/EffectOfM_Referees.pdf}
...
\begin{figure}[htp]
\begin{center}
\includegraphics[width=.75\textwidth]{Figs/FP/sdf_init_vs_exact.pdf}
...
% {Figs/Estimates/FP_vs_Fortet_100x1000superSin_est_rel_errors.png}
% }
\includegraphics[width=0.8\textwidth]{Figs/Estimates/FP_vs_Fortet_100x100_x1000superSin_est_rel_errors_joint.pdf}
...
% {Figs/Estimates/FP_vs_Fortet_100x1000crit_est_rel_errors.png}
% }
\includegraphics[width=0.8\textwidth]{Figs/Estimates/FP_vs_Fortet_100x100_x1000crit_est_rel_errors_joint.pdf}
...
% {Figs/Estimates/FP_vs_Fortet_100x1000subT_est_rel_errors.png}
% }
\includegraphics[width=0.8\textwidth]{Figs/Estimates/FP_vs_Fortet_100x100_x1000subT_est_rel_errors_joint.pdf}
...
\begin{figure}[htp]
\begin{center} 
  \includegraphics[width=0.8\textwidth]{Figs/Estimates/MLE_N100_cross_compare_joint.pdf}
...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=0.8\textwidth]{Figs/Estimates/MLE_N1000_cross_compare_joint.pdf}
