...
\abstract{
Given a leaky, noisy integrate-and-fire
neuronal model - we discuss the optimal design problem on what is the
best external perturbation in order to facilitate parameter estimation of
the model's characteristic time parameter using inter-spike intervals
observations only.}
...
in the bottom panel we show the corresponding evolution of the objective.

TODO: If keep these figures - make nicer}
...
{/home/alex/Workspaces/Latex/OptEstimate/Figs/HitTime_MI_TauChar_Adjoint_Estimate/Adjoint_TauChar_Estimator_good_vs_bad_estimates_Nh1000.pdf}
}\\
\subfloat[1e4 Hits]
{
\includegraphics[width=0.98\textwidth]
{/home/alex/Workspaces/Latex/OptEstimate/Figs/HitTime_MI_TauChar_Adjoint_Estimate/Adjoint_TauChar_Estimator_good_vs_bad_estimates_Nh10000.pdf}
}
